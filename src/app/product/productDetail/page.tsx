...
const ProductDetail = () => {
  return (
    <div className="flex flex-wrap gap-x-5 justify-center p-5 bg-[#eee] min-h-[100vh]">
        ...
        .map((_, index) => (
          <div key={index} className="card">
            <div className="p-5 text-center text-base">
              <h1>Apps</h1>
              <p>
                Gạo ST25 Premium, một bước đột phá mới, không chỉ về chất lượng
                mà còn ở sự sáng tạo trong cách tiếp cận thị trường. Điểm nhấn
                đặc biệt của dòng sản phẩm này chính là sự kết hợp độc đáo với
                hai nhân vật nổi tiếng và được đông đảo công chúng yêu mến –
